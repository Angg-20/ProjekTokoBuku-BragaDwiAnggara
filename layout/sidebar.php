<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
  ...
  <ul class="menu-inner py-1">
    ...
    <!-- Tables -->
    <li class="menu-item">
      <a href="../Distributor/TabelDistributor.php" class="menu-link">
        <i class="menu-icon tf-icons bx bx-table"></i>
        <div data-i18n="Tables">Tabel Distributor</div>
      </a>
    </li>
    
    <li class="menu-item">
      <a href="../Pasok/TabelPasok.php" class="menu-link">
        <i class="menu-icon tf-icons bx bx-layout"></i>
        <div data-i18n="Analytics">Tabel Pasok</div>
      </a>
    </li>
    
    <li class="menu-item">
      <a href="../Buku/TabelBuku.php" class="menu-link">
        <i class="menu-icon tf-icons bx bx-table"></i>
    ...
    <li class="menu-item">
      <a href="../Kasir/TabelKasir.php" class="menu-link">
        <i class="menu-icon tf-icons bx bx-layout"></i>
        <div data-i18n="Analytics">Tabel Kasir</div>
      </a>
    </li>
