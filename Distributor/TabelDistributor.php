                    ...
                    <tbody>
                        ...
                        <?php foreach ($hasil as $dis) { ?>
                            <tr>
                                ...
                                <td><?= $dis['telepon']; ?></td>
                                <td>
                                    <a href="edit.php?id=<?= $dis['id_distributor']; ?>" class="btn btn-primary" style="width: 90px;">Edit</a>
                                    <a href="delete.php?id=<?= $dis['id_distributor']; ?>" class="btn btn-danger" style="width: 90px;">Hapus</a>
                                </td>
                            </tr>
                            <?php $i++; ?>
                        <?php  }  ?>
